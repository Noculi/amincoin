...
{
    if(uri.scheme() != QString("amincoin"))
        return false;
...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("amincoin://"))
    {
        uri.replace(0, 11, "amincoin:");
    }
...
{
    return GetAutostartDir() / "amincoin.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("amincoin-qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  amincoin-qt [" + tr("command-line options") + "]                     " + "\n";
